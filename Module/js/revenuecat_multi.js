...
> Original: latesttechnical (revenuecat_multi.js)
...
if (match) {
  ...
  s ? (locketGold.product_identifier = s, obj.subscriber.subscriptions[s] = latesttechnical) : obj.subscriber.subscriptions["locket_1600_1y"] = latesttechnical, obj.subscriber.entitlements[e] = locketGold
} else obj.subscriber.subscriptions["locket_1600_1y"] = latesttechnical, obj.subscriber.entitlements.pro = locketGold;
$done({
